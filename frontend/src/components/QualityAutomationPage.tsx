      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10 space-y-24">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[1fr_1.35fr] gap-16 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter leading-[1.1]">
                ...
                <span className="bg-gradient-to-r from-blue-400 to-blue-200 bg-clip-text text-transparent">Automatically.</span>
              </h1>
          ...
          <div className="space-y-6 relative">
            ...
            {/* Dashboard Container */}
            <div className="relative bg-[#0A0A0A]/85 backdrop-blur-3xl border border-blue-500/30 rounded-none shadow-[0_0_50px_rgba(59,130,246,0.15)] p-6 z-10 space-y-6">
              
              {/* Header metrics */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-outline/20">
                <div>
                  <h3 className="font-bold text-xs uppercase tracking-wider text-blue-400">Call Evaluation Analytics</h3>
                  <p className="text-xl font-bold text-white">Representative: {selectedRep}</p>
                </div>
                
                {/* Massive overall score */}
                <div className="flex items-center gap-3 bg-blue-500/10 border border-blue-500/20 px-4 py-2">
                  <span className="text-3xl font-black text-blue-400 font-mono">84%</span>
                  <div className="leading-tight">
                    <span className="text-xs text-on-surface-variant block uppercase font-bold tracking-wider">Overall QA Score</span>
                    <span className="text-xs text-blue-400 font-bold font-mono">GRADE: GOOD</span>
                  </div>
                </div>
              </div>
                    ...
                    {metricsList.map((m, idx) => (
                      <div key={idx} className="space-y-1.5">
                        <div className="flex justify-between text-sm font-semibold text-white/90">
                          <span>{m.name}</span>
                          <span className="text-blue-400 font-mono">{m.score}/100</span>
                        </div>
                        <div className="w-full bg-[#1C1C1E] h-1.5 rounded-none overflow-hidden">
                          <div className="bg-blue-500 h-full" style={{ width: `${m.score}%` }}></div>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-[#101012] border border-outline/35 p-4 space-y-4">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-1.5 text-xs font-bold uppercase text-blue-400 font-mono">
              ...
              <div className="border-t border-outline/20 pt-4 flex justify-between items-center text-xs font-mono text-on-surface-variant/60">
                ...
                <span className="text-blue-400 uppercase tracking-widest font-bold">100% of calls audited</span>
              </div>
        ...
        <section className="space-y-16 pt-16 mt-16 border-t border-outline/20">
          <div className="space-y-4 max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white">
              ...
              <span className="bg-gradient-to-r from-blue-400 to-blue-200 bg-clip-text text-transparent">Enablement.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 border border-outline/20">
            ...
            <div className="relative group p-8 border-b lg:border-b-0 lg:border-r border-outline/20 bg-surface/30 hover:bg-surface/60 transition-colors">
              ...
              <div className="relative z-10 space-y-16">
                <div className="flex justify-between items-start">
                  <div className="w-12 h-12 flex items-center justify-center bg-blue-500/10 border border-blue-500/30">
                    <span className="material-symbols-outlined text-2xl text-blue-400">checklist</span>
                  </div>
            ...
            <div className="relative group p-8 bg-surface/30 hover:bg-surface/60 transition-colors">
              ...
              <div className="relative z-10 space-y-16">
                <div className="flex justify-between items-start">
                  <div className="w-12 h-12 flex items-center justify-center bg-blue-500/10 border border-blue-500/30">
                    <span className="material-symbols-outlined text-2xl text-blue-400">group_add</span>
                  </div>
