      ...
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-on-surface-variant">
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-on-surface">1. Data Collection & Usage</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-on-surface">3. Hosting & Security Infrastructure</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-on-surface">4. Account Termination & Data Deletion</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-on-surface">5. Contact and Inquiries</h2>
            <p>
